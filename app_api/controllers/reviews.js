...
var doAddReview;
var updateAverageRating;
var doSetAverageRating;
...
module.exports.reviewsUpdateOne = function (req, res) {
    if (!rep.params.locationid || !req.params.reviewid) {
        sendJsonResponse(res, 404, {'message': 'missing location id or review id'});
        return;
    }
    Loc
        .findById(req.params.locationid)
...
module.exports.reviewsDeleteOne = function (req, res) {
    if (!req.params.locationid || !req.params.reviewid){
        sendJsonResponse(res, 404, {'message':'Not found: locationid and reviewid are required inputs'});
        return;
    }
    Loc
        .findById(rep.params.locationid)
        .select('reviews')
        .exec(
            function(err, location) {
                if (!location) {
